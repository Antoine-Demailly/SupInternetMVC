...
<div class="main-content">
    ...
    <div class="left">
        ...
        <nav>
            <ul>
                ...
                <li><a href="<?php echo $router->generateUrl('trottinettes')?>" class="nav-link nav-link-active">Trottinettes</a></li>
    ...
    <div class="top">
        <h1 class="title">Trottinettes</h1>
    ...
    <div class="content">
        ...
        <div id="CustomersTab">
            <div class="tab-menu">
                <span class="tab-link tab-link-left tab-link-active link-left">En service</span>
                <span class="tab-link tab-link-middle link-middle">Réparations</span>
                <span class="tab-link tab-link-right link-right">Hors Service</span>
                <div class="clear"></div>
            </div>
                ...
                <div class="tab-wrap">
                        ...
                        <div class="content-table">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><span onclick="modeEdition(this);" editionmode="scooters" editionid="<?php echo $value['id'];?>" class="edition">GERER</span></td>
                                </tr>
                            <?php
                                }
                            ?>
                    ...
                    <div class="tab" id="tab-middle">
                        <div class="content-table">
                            ...
                            <?php 
                                foreach ($response['maintenance'] as $value) {
                            ?>
                                <tr>
                                    <td><?php echo $value['numero']; ?></td>
                                    <td><?php echo $value['date_service']; ?></td>
                        ...
                        <div class="content-table">
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $value['numero']; ?></td>
                                    <td><?php echo $value['date_service']; ?></td>
                                    <td><?php echo $value['date_hors_service']; ?></td>
